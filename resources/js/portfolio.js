        ...
        card.addEventListener("click", () => {
            if (card.classList.contains("web")) {
                ...
                portfolioView({
                    ...
                    project_brief: `Visit the links in Portfolio for detail about project.`,

                    project_date: "2022",
                    project_client: "Freelancing clients",
                     project_link: `www.${website}.com`,

                    image: [
                        "resources/img/portfolios/web/1.webp",
                        "resources/img/portfolios/web/15.png",
                        "resources/img/portfolios/web/9.png",
                        "resources/img/portfolios/web/11.jpg",
                        "resources/img/portfolios/web/4.png",
                        "resources/img/portfolios/web/9.jpg",
                        "resources/img/portfolios/web/10.webp",
                        "resources/img/portfolios/web/12.webp",
                        "resources/img/portfolios/web/13.jpg",
                        "resources/img/portfolios/web/14.webp",
